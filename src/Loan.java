...
public class Loan extends JFrame {
    ...
    private JTextField collateral_textField;

    public Loan(Service_customer service_customer_Handle, Customer customer) {
        this.setSize(FORM_WIDTH, FORM_Height);
        this.setLocationRelativeTo(null);
        this.setTitle("Profiteer Bank - Loan");
        ...
        enterButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                int serviceFee = Services.SERVICE_FEE_MAP.get("loan");
                ...
                if (checkInputInformation()) {
                    ...
                    if (result == 0) {//YES
                        ...
                        customer.getAccounts().get(customer.findAccount(accountNum)).settleServiceFee("loan");
                        // settle balance for customer
                        customer.settleBalacne();
                        // settle loan for customer
                        customer.setLoan(amountInFloat);

                        //add record
                        String note = collateral_textField.getText() + " as collateral.";
                        Record record = new Record(customer, accountNum, "loan", amountInFloat, note);
                        ...
                        JOptionPane.showMessageDialog(null,
                                customer.getName().getFirstName() + ", you loaned " + currency + amount + "\nAccount num: " + accountNum + "\nBalance: $" + balance);
                        closeFrame();
    ...
    private boolean checkInputInformation() {
        ...
        if (choose_account_comboBox.getSelectedItem().toString().equals("No account available.")) {
            ...
            alarm_panel.setText("Type in loan amount.");
            return false;
        } else if (collateral_textField.getText().equals("")) {
            alarm_panel.setText("Please type in your collateral for this loan.");
            return false;
        } else return true;
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        wholePanel.add(panel2, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        wholePanel.add(panel3, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        wholePanel.add(panel5, new GridConstraints(6, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        wholePanel.add(panel6, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        ...
        wholePanel.add(panel8, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JLabel label5 = new JLabel();
        label5.setForeground(new Color(-16777216));
        label5.setText("Your collateral:");
        ...
        panel8.add(spacer13, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        collateral_textField = new JTextField();
        collateral_textField.setBackground(new Color(-1118482));
        collateral_textField.setForeground(new Color(-16777216));
        panel8.add(collateral_textField, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final Spacer spacer14 = new Spacer();
        panel8.add(spacer14, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
    }
